...
describe("Personal wallet", () => {
  ...
  it("should be able to recover with recovery phrase", () => {
    ...
    cy.get("aside").get("a").contains("New Wallet").click();
    cy.get("div").find("nav button").contains("Personal").click();
  ...
  it("should be able to save", () => {
    ...
    cy.get("div").should(
      "have.contain.text",
      "stake_test1uqhy9wspj5mhwz3jjw5sw7d8750mhqryg93xz562vkjwxpccdkfkl",
    );

    cy.contains("Receive").click();

    cy.contains(
      "addr_test1qry97t0n3a6g4uaj9shz4lz4rsuwsjwaup4te83gaxhageewg2aqr9fhwu9r9yafqau60aglhwqxgstzv9f55edyuvrsku53n7",
    )
      .closest("td")
      .next("td")
    ...
    cy.contains(
      "addr_test1qzn4k2ss3tgdt7ayg44knneavn0e6gemg7al2wptnvv2fsewg2aqr9fhwu9r9yafqau60aglhwqxgstzv9f55edyuvrs0487rk",
    )
      .closest("td")
      .next("td")
    ...
    cy.contains(
      "addr_test1qr32njg56puy8cndc57vukg9205ydze4h9tk0qp2552hwzewg2aqr9fhwu9r9yafqau60aglhwqxgstzv9f55edyuvrs7f7txu",
    )
      .closest("td")
      .next("td")
  ...
  it("should be able to add personal address", () => {
    ...
    cy.contains("m/1852'/1815'/0'/0/6")
      ...
      .should(
        "have.contain.text",
        "addr_test1qrz22ravvdmee9389wvaqgdkfptwzjfv4adut35faeygzsfwg2aqr9fhwu9r9yafqau60aglhwqxgstzv9f55edyuvrsrc0m0h",
      );
  });
  ...
  it("should be able to add personal accounts", () => {
    ...
    cy.contains(
      "addr_test1qz856plw0a560m23p5j6jwjj3sezjnrya0q6qjs7uezvrzqlcrjtpd2lkd088ka782nu8937fklr5lw75xs49wkhs6gsjyg4yw",
    )
      .closest("td")
      .next("td")
    ...
    cy.contains(
      "addr_test1qz48vjvgvy72z8s9rthx3g64cpenp5g39r6glz3n98zcpkqlcrjtpd2lkd088ka782nu8937fklr5lw75xs49wkhs6gsu2lnfg",
    )
      .closest("td")
      .next("td")
    ...
    cy.contains(
      "addr_test1qrfkagyyk6la02rvrfp7042h6d8e8a5j4depefrac3m94nqlcrjtpd2lkd088ka782nu8937fklr5lw75xs49wkhs6gsp9hpxw",
    )
      .closest("td")
      .next("td")
  ...
  it("should have multisig addresses created", () => {
    ...
    cy.contains(
      "addr_test1qzp420vrmccgp4prr2axyjzvjj0qec8d4wdfhamcr9rw0v2afzulsnxumxuw66c2883rj3hv6027uxcvt4qry92hjess4uch94",
    )
      .closest("td")
      .next("td")
    ...
    cy.contains(
      "addr_test1qpxvl6tnc2d9adsr0p0508xsjxewwsx7snkp3xffgume3qyfn88gvkfnmscje2sazy7mmrsm8n5tkvfr8n7dhezdmhnqng95xm",
    )
      .closest("td")
      .next("td")
  ...
  it("should be able to be backed up", () => {
    ...
    cy.get("#modal-root").contains("Data").click();

    cy.get("#modal-root").contains("Export User Data").click();
  });
  ...
  it("should be able to get removed", () => {
    ...
    cy.get("footer").get("button").contains("REMOVE").click();
  });
  ...
  it("should be able to be restored", () => {
    ...
    const downloadedFilename =
      downloadsFolder + "/roundtable-backup.preview.json";

    cy.get("input[type=file]").selectFile(downloadedFilename);

    cy.wait(1000);

    cy.get("#modal-root button").contains("Import").click();
